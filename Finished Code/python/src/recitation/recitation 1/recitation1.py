...
def prime_count_array(n: int):
    """prime_count_array takes in an integer n and returns
        an array of 0's and 1's, where each index represents a number
        and the value at that index tells you how many primes there have been
        up to that point 
        input: n: int
        output: list with number of primes seen so far
        
        ex: n = 10 -> [0, 0, 1, 2, 2, 3, 3, 4, 4, 4, 4] """
